...
define([
  ...
  CheckBox, PopupMenu,
  Metadata,
  _TemplatedMixin, template, LoadingIndicator,
  ...
  return declare([_WidgetBase, _TemplatedMixin], {
    ...
    addLayerNode: function(layerInfo, level, toTableNode) {
      ...
      }, toTableNode), layerTdNode,metadataTdNode, ckSelectDiv, ckSelect, imageShowLegendNode, imageNoLegendDiv,
      imageNoLegendNode,metadataNode, popupMenuNode, i, imageShowLegendDiv, popupMenu, divLabel;
      ...
      metadataTdNode = domConstruct.create('td', {
          'class': 'col col3'
      }, layerTrNode);
      if (layerInfo.newSubLayers.length === 0) {
          this.metadata._init(metadataTdNode,layerInfo)
      }
      ...
      this.scaleConfig.push({
          layerInfo: layerInfo,
          layerNode: layerTrNode
      });
